            ...
            <div class="card col-12 p-4">
                ...
                <div style="max-height: 500px; overflow-y: auto;" class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th style="position: sticky; left: 0; top:0; background-color: white; z-index:1;">Pegawai</th>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="position: sticky; right: 0; background-color: white; background-color: {{ $employee->rangking == 1 ? 'red' : ($employee->rangking == 2 ? 'yellow' : ($employee->rangking == 3 ? 'green' : 'white')) }}" class="text-center">{{$employee->rangking}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
